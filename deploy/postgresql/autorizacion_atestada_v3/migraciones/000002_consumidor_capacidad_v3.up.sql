...
DECLARE
    ...
    v_claves constant text[] := ARRAY[
        'esquema', 'version', 'clave_id', 'clave_version',
        'revision_gobierno', 'huella_gobierno_sha256', 'emisor_id',
        'audiencia_consumo', 'nonce', 'emitida_en', 'expira_en',
        'decision_ref', 'huella_decision_sha256',
        'huella_motivo_sha256', 'huella_payload_vec_ad_3_sha256',
        'huella_sobre_cose_sign1_sha256',
        'huella_prueba_confianza_sha256', 'contexto_ref',
        'huella_contexto_sha256', 'audiencia_despliegue', 'operacion',
        'efecto_ref', 'huella_efecto_sha256', 'decision_valida_hasta',
...
BEGIN
    IF p_capacidad IS NULL
       OR pg_catalog.octet_length(p_capacidad) NOT BETWEEN 512 AND 32768 THEN
        RETURN false;
    END IF;
    v_texto := pg_catalog.convert_from(p_capacidad, 'UTF8');
    IF pg_catalog.left(v_texto, 1) <> '{'
...
AS $funcion$
    SELECT pg_catalog.convert_to(
      '{"esquema":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'esquema') ||
      ',"version":' || (c -> 'version')::text ||
      ',"clave_id":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'clave_id') ||
      ',"clave_version":' || (c -> 'clave_version')::text ||
      ',"revision_gobierno":' || (c -> 'revision_gobierno')::text ||
      ',"huella_gobierno_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_gobierno_sha256') ||
      ',"emisor_id":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'emisor_id') ||
      ',"audiencia_consumo":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'audiencia_consumo') ||
      ',"nonce":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'nonce') ||
      ',"emitida_en":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'emitida_en') ||
      ',"expira_en":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'expira_en') ||
      ',"decision_ref":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'decision_ref') ||
      ',"huella_decision_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_decision_sha256') ||
      ',"huella_motivo_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_motivo_sha256') ||
      ',"huella_payload_vec_ad_3_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_payload_vec_ad_3_sha256') ||
      ',"huella_sobre_cose_sign1_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_sobre_cose_sign1_sha256') ||
      ',"huella_prueba_confianza_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_prueba_confianza_sha256') ||
      ',"contexto_ref":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'contexto_ref') ||
      ',"huella_contexto_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_contexto_sha256') ||
      ',"audiencia_despliegue":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'audiencia_despliegue') ||
      ',"operacion":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'operacion') ||
      ',"efecto_ref":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'efecto_ref') ||
      ',"huella_efecto_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_efecto_sha256') ||
      ',"decision_valida_hasta":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'decision_valida_hasta') ||
      ',"verificada_en":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'verificada_en') ||
      ',"revision_confianza":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'revision_confianza') ||
      ',"configuracion_secuencia":' || (c -> 'configuracion_secuencia')::text ||
      ',"huella_configuracion_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_configuracion_sha256') ||
      ',"configuracion_publicada_en":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'configuracion_publicada_en') ||
      ',"configuracion_expira_en":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'configuracion_expira_en') ||
      ',"raiz_clave_id":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'raiz_clave_id') ||
      ',"raiz_version":' || (c -> 'raiz_version')::text ||
      ',"huella_raiz_spki_sha256":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'huella_raiz_spki_sha256') ||
      ',"raiz_valida_desde":' || vec_autorizacion_atestada_v3.texto_json_go(c ->> 'raiz_valida_desde') ||
...
AS $funcion$
    SELECT pg_catalog.string_agg(
      ...
      FROM (VALUES
        ...
        (5,c ->> 'revision_gobierno'),
        (6,c ->> 'huella_gobierno_sha256'), (7,c ->> 'emisor_id'),
        (8,c ->> 'audiencia_consumo'), (9,c ->> 'nonce'),
        (10,c ->> 'emitida_en'), (11,c ->> 'expira_en'),
        (12,c ->> 'decision_ref'), (13,c ->> 'huella_decision_sha256'),
        (14,c ->> 'huella_motivo_sha256'),
        (15,c ->> 'huella_payload_vec_ad_3_sha256'),
        (16,c ->> 'huella_sobre_cose_sign1_sha256'),
        (17,c ->> 'huella_prueba_confianza_sha256'),
        (18,c ->> 'contexto_ref'), (19,c ->> 'huella_contexto_sha256'),
        (20,c ->> 'audiencia_despliegue'), (21,c ->> 'operacion'),
        (22,c ->> 'efecto_ref'), (23,c ->> 'huella_efecto_sha256'),
        (24,c ->> 'decision_valida_hasta'), (25,c ->> 'verificada_en'),
        (26,c ->> 'revision_confianza'),
        (27,c ->> 'configuracion_secuencia'),
        (28,c ->> 'huella_configuracion_sha256'),
        (29,c ->> 'configuracion_publicada_en'),
...
BEGIN
    IF pg_catalog.octet_length(p_primero) = 0
       OR pg_catalog.octet_length(p_segundo) = 0 THEN
        RETURN pg_catalog.octet_length(p_primero) =
...
DECLARE
    ...
    v_raiz numeric(20, 0);
BEGIN
    SELECT coalesce(pg_catalog.max(c.secuencia), 0)
      INTO v_secuencia
...
BEGIN
    ...
    IF vec_autorizacion_atestada_v3.capacidad_tipos_validos(c) IS NOT TRUE
       ...
       OR c ->> 'version' <> '3'
       OR c ->> 'audiencia_consumo' <>
          'vec_contratacion_temporal.confirmar_alta_atestada.v1'
       OR c ->> 'operacion' <> 'contratacion_temporal.solicitud.crear'
