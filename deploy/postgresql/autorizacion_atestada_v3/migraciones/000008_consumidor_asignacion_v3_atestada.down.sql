...
BEGIN
    IF pg_catalog.to_regprocedure(
       ...
       OR pg_catalog.to_regprocedure(
        ...
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'consumidor de asignación VEC-AD-3 no instalado';
    END IF;
    SELECT
        EXISTS (
            SELECT 1
    ...
    IF v_hay_historia THEN
        RAISE EXCEPTION USING
            ERRCODE = '55000',
            MESSAGE = 'reversión protegida: existe historia de asignación';
    END IF;
END
$proteccion$;
...
CREATE OR REPLACE FUNCTION vec_autorizacion_atestada_v3.registrar_y_consumir_decision_v3_atestada(
