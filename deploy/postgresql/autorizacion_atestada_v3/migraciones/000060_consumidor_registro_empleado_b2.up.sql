...
-- Personal B2: cuatro operaciones nominales. Instalar después de AD3-59.
BEGIN;
...
BEGIN
 ...
 THEN RAISE EXCEPTION 'AD3-60: preimagen incompatible' USING ERRCODE='55000'; END IF;
 ...
 THEN RAISE EXCEPTION 'AD3-60: núcleo incompatible' USING ERRCODE='55000'; END IF;
 ...
 THEN RAISE EXCEPTION 'AD3-60: núcleo alterado fuera de contrato' USING ERRCODE='55000'; END IF;
END $nucleo$;
...
BEGIN
 ...
 THEN RAISE EXCEPTION 'AD3-60: audiencias previas incompatibles' USING ERRCODE='55000'; END IF;
 nueva:=left(d,length(d)-3);
 FOREACH audiencia IN ARRAY lista LOOP
  IF strpos(d,quote_literal(audiencia))<>0 THEN
   RAISE EXCEPTION 'AD3-60: audiencia ya registrada' USING ERRCODE='55000'; END IF;
...
BEGIN
 ...
 THEN RAISE EXCEPTION 'AD3-60: operación denegada' USING ERRCODE='42501'; END IF;
