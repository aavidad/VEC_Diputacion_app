...
BEGIN
 ...
 OR EXISTS(SELECT 1 FROM pg_proc WHERE pronamespace='vec_identidad_sesiones_v1'::regnamespace AND proname='leer_autenticacion_original_v1')
 ...
 EXECUTE format('REVOKE CONNECT ON DATABASE %I FROM vec_identidad_sesiones_v1_lector_historico RESTRICT',current_database());
END $retirada$;
DROP ROLE vec_identidad_sesiones_v1_lector_historico;
COMMIT;
