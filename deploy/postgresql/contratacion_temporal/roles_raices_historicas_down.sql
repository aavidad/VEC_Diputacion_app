...
BEGIN
 ...
 OR EXISTS(SELECT 1 FROM pg_proc WHERE pronamespace='vec_contratacion_temporal'::regnamespace AND proname='leer_raices_incorporacion_ejercicio_v2')
 ...
 EXECUTE format('REVOKE CONNECT ON DATABASE %I FROM vec_contratacion_temporal_lector_raices_historicas RESTRICT',current_database());
END $retirada$;
DROP ROLE vec_contratacion_temporal_lector_raices_historicas;
COMMIT;
