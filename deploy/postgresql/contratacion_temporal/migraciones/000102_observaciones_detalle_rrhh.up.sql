...
SELECT pg_advisory_xact_lock(hashtextextended('vec_contratacion_temporal:migracion:000102',0));

-- CT-000102: soporte de observaciones en el detalle de RRHH.
-- 1. Añade el atributo 'observaciones' a analisis_operativo_rrhh_v1.
-- 2. Actualiza materializar_detalle_rrhh_v1 para propagar observaciones.
-- 3. Actualiza canon_contenido_detalle_rrhh_v1 a versión V2 incluyendo observaciones.

ALTER TYPE vec_contratacion_temporal.analisis_operativo_rrhh_v1
    ADD ATTRIBUTE observaciones text;
