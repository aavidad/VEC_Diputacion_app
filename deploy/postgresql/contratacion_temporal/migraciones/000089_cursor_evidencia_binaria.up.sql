...
-- CT89: el localizador durable conserva SHA-256 del texto Base64URL; la
-- evidencia de resultado conserva SHA-256 de sus 32 bytes decodificados.
BEGIN;
    ...
    LOOP
        ...
        IF NOT FOUND
           ...
           OR (length(antes.definicion) - length(replace(antes.definicion, antes.cuerpo, '')))
            ...
            RAISE EXCEPTION 'CT89: fuente de cursor incompatible' USING ERRCODE = '55000';
        END IF;
