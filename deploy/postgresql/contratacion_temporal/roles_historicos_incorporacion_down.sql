...
BEGIN
 ...
 OR EXISTS(SELECT 1 FROM pg_proc WHERE pronamespace='vec_contratacion_temporal'::regnamespace AND proname='leer_historia_incorporacion_original_v2')
 ...
 EXECUTE format('REVOKE CONNECT ON DATABASE %I FROM vec_contratacion_temporal_lector_historia_incorporacion RESTRICT',current_database());
END $retirada$;
DROP ROLE vec_contratacion_temporal_lector_historia_incorporacion;
COMMIT;
