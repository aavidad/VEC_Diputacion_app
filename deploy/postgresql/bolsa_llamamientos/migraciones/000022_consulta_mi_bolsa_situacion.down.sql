...
SELECT pg_advisory_xact_lock(hashtextextended('vec_bolsa_llamamientos:migracion:000022', 0));

-- Restaura solo la proyeccion anterior; no modifica situaciones ni auditoria.
DO $precondicion$
BEGIN
 IF current_user <> 'vec_bolsa_llamamientos_propietario'
   ...
   RAISE EXCEPTION 'estado incompatible para revertir consulta Mi bolsa con situacion' USING ERRCODE='55000';
 END IF;
END $precondicion$;
