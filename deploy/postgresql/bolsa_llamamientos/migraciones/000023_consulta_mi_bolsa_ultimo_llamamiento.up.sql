...
SELECT pg_advisory_xact_lock(hashtextextended('vec_bolsa_llamamientos:migracion:000023', 0));

-- B11: proyecta el ultimo resultado de correo B7 para cada participacion propia.
-- No expone configuracion, notas, actor, recibo, destinatario ni referencias internas.
DO $precondicion$
BEGIN
 IF current_user <> 'vec_bolsa_llamamientos_propietario'
    ...
    OR to_regclass('vec_bolsa_llamamientos.contacto_participacion') IS NULL THEN
