...
"$raiz/deploy/postgresql/contexto_actor_v1/probar_vinculo_corporativo_rrhh_v1_estructura_adversarial_pg18_4.sh"
"$raiz/deploy/postgresql/contexto_actor_v1/probar_vinculo_corporativo_rrhh_v1_concurrencia_preservacion_pg18_4.sh"
"$raiz/deploy/postgresql/contexto_actor_v1/probar_vinculo_corporativo_rrhh_v1_pgx_pg18_4.sh"
