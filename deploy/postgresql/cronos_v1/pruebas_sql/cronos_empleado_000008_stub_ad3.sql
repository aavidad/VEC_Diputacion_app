...
-- SOLO para el arnés desechable de cronos_v1 000008. Fachadas AD3-70 de
-- prueba sobre el esquema que crea el stub de 000007: no verifican MAC, COSE
...
BEGIN
 FOR fachada,audiencia IN VALUES
   ('consumir_cronos_movimientos_propio_v3_atestada','vec_cronos_v1.movimientos_propio.consultar.v1'),
   ('registrar_y_consumir_cronos_correccion_v3_atestada','vec_cronos_v1.correccion_propia.solicitar.v1'),
   ('consumir_cronos_permisos_propio_v3_atestada','vec_cronos_v1.permisos_propio.consultar.v1'),
   ('registrar_y_consumir_cronos_permiso_v3_atestada','vec_cronos_v1.permiso_propio.solicitar.v1') LOOP
  EXECUTE format($f$
