...
-- SOLO para el arnés desechable de cronos_v1 000009. Fachadas AD3-57 de
-- prueba sobre el esquema que crea el stub de 000007 (y usa su tabla de nonces): no verifican MAC, COSE
-- ni gobierno; imitan el contrato de salida, la guarda de sesión del
-- ejecutor y el rechazo de replay por nonce. No es migración.
DO $stub$
DECLARE fachada text; audiencia text;
BEGIN
 FOR fachada,audiencia IN VALUES
   ('consumir_cronos_bandeja_permisos_v3_atestada','vec_cronos_v1.permisos_bandeja.consultar.v1'),
   ('registrar_y_consumir_cronos_resolucion_permiso_v3_atestada','vec_cronos_v1.permiso.resolver.v1'),
   ('consumir_cronos_avisos_propio_v3_atestada','vec_cronos_v1.avisos_propio.consultar.v1'),
   ('registrar_y_consumir_cronos_archivo_aviso_v3_atestada','vec_cronos_v1.aviso_propio.archivar.v1') LOOP
  EXECUTE format($f$
