...
DO $retirada$
DECLARE r oid:='vec_autorizacion_evaluacion_historica_lector'::regrole;
...
BEGIN
 ...
 EXECUTE format('REVOKE CONNECT ON DATABASE %I FROM vec_autorizacion_evaluacion_historica_lector RESTRICT',current_database());
END $retirada$;
DROP ROLE vec_autorizacion_evaluacion_historica_lector;
COMMIT;
