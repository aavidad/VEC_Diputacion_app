...
-- Misma identidad técnica, nueva vigencia desde 2025 conocida en 2026.
-- Consultar 2024 con conocimiento 2026 debe seguir viendo las seis revisiones 1.
INSERT INTO vec_personal.version_rpt_historia
 (version_ref,revision,organismo_ref,codigo_version_fuente,estado,vigente_desde,conocido_desde,
  fuente_ref,documento_ref,acto_ref,huella_fuente_sha256)
 VALUES('44444444-4444-4444-8444-444444444444',2,'org:otra','rpt-2025','publicada','2025-01-01','2026-01-01+00',
  'fuente:prueba','documento:rpt','acto:rpt2025',repeat('a',64));
INSERT INTO vec_personal.version_plantilla_historia
 (version_ref,revision,organismo_ref,ejercicio,codigo_version_fuente,estado,vigente_desde,conocido_desde,
  fuente_ref,documento_ref,acto_ref,huella_fuente_sha256)
 VALUES('55555555-5555-4555-8555-555555555555',2,'org:otra',2025,'plantilla-2025','publicada','2025-01-01','2026-01-01+00',
  'fuente:prueba','documento:plantilla','acto:plantilla2025',repeat('b',64));
INSERT INTO vec_personal.org_nodo_historia
 (nodo_ref,revision,organismo_ref,unidad_ref,clase,catalogo_ref,catalogo_version,catalogo_revision,
  catalogo_entrada_clave,denominacion,vigente_desde,conocido_desde,fuente_ref,acto_ref,huella_fuente_sha256)
 VALUES('22222222-2222-4222-8222-222222222222',2,'org:otra','unidad:dos','centro','estructura-organizativa-dipgra',
  1,2,'unidad:dos','Centro 2 actualizado','2025-01-01','2026-01-01+00','fuente:prueba','acto:centro2025',repeat('c',64));
INSERT INTO vec_personal.puesto_tipo_historia
 (tipo_ref,revision,organismo_ref,unidad_ref,rpt_version_ref,rpt_revision,codigo_fila_fuente,denominacion,
  clasificacion_ref,vigente_desde,conocido_desde,fuente_ref,acto_ref,huella_fuente_sha256)
 VALUES('66666666-6666-4666-8666-666666666666',2,'org:otra','unidad:dos',
  '44444444-4444-4444-8444-444444444444',2,'fila:uno','Administrativo actualizado','clasificacion:uno',
  '2025-01-01','2026-01-01+00','fuente:prueba','acto:tipo2025',repeat('d',64));
INSERT INTO vec_personal.dotacion_rpt_historia
 (dotacion_ref,revision,organismo_ref,unidad_ref,tipo_ref,tipo_revision,cantidad,reconciliacion,
  vigente_desde,conocido_desde,fuente_ref,acto_ref,huella_fuente_sha256)
 VALUES('77777777-7777-4777-8777-777777777777',2,'org:otra','unidad:dos',
  '66666666-6666-4666-8666-666666666666',2,20,'parcial',
  '2025-01-01','2026-01-01+00','fuente:prueba','acto:dotacion2025',repeat('e',64));
INSERT INTO vec_personal.plaza_plantilla_historia
 (plaza_ref,revision,organismo_ref,unidad_ref,plantilla_version_ref,plantilla_revision,codigo_plaza_fuente,
  clasificacion_ref,estado_estructural,dotacion_presupuestaria,vigente_desde,conocido_desde,fuente_ref,acto_ref,huella_fuente_sha256)
 VALUES('88888888-8888-4888-8888-888888888888',2,'org:otra','unidad:dos',
  '55555555-5555-4555-8555-555555555555',2,'00001','clasificacion:uno','vigente','acreditada',
  '2025-01-01','2026-01-01+00','fuente:prueba','acto:plaza2025',repeat('f',64));
INSERT INTO vec_personal.puesto_rpt_historia
 (puesto_ref,revision,organismo_ref,unidad_ref,tipo_ref,tipo_revision,codigo_puesto_fuente,estado_estructural,
  vigente_desde,conocido_desde,fuente_ref,acto_ref,huella_fuente_sha256)
 VALUES('99999999-9999-4999-8999-999999999999',2,'org:otra','unidad:dos',
  '66666666-6666-4666-8666-666666666666',2,'0001','vigente',
  '2025-01-01','2026-01-01+00','fuente:prueba','acto:puesto2025',repeat('a',64));
INSERT INTO vec_personal.vinculo_plaza_puesto_historia
 (vinculo_ref,revision,organismo_ref,unidad_ref,plaza_ref,plaza_revision,puesto_ref,puesto_revision,estado,
  vigente_desde,conocido_desde,fuente_ref,acto_ref,huella_fuente_sha256)
 VALUES('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa',2,'org:otra','unidad:dos',
  '88888888-8888-4888-8888-888888888888',2,'99999999-9999-4999-8999-999999999999',2,'confirmado',
  '2025-01-01','2026-01-01+00','fuente:prueba','acto:vinculo2025',repeat('b',64));
DO $regresion$
...
BEGIN
 ...
 BEGIN
  INSERT INTO vec_personal.version_rpt_historia
   (version_ref,revision,organismo_ref,codigo_version_fuente,estado,vigente_desde,conocido_desde,
    fuente_ref,documento_ref,acto_ref,huella_fuente_sha256)
   VALUES('44444444-4444-4444-8444-444444444444',3,'org:otra','rpt-borrador','preparacion',
    '2026-01-01','2026-07-01+00','fuente:prueba','documento:rpt','acto:regresion',repeat('a',64));
 EXCEPTION WHEN object_not_in_prerequisite_state THEN rechazada:=true;
 END;
 IF NOT rechazada THEN RAISE EXCEPTION 'RPT publicada retrocedió a preparación'; END IF;
 rechazada:=false;
 BEGIN
  INSERT INTO vec_personal.version_plantilla_historia
   (version_ref,revision,organismo_ref,ejercicio,codigo_version_fuente,estado,vigente_desde,conocido_desde,
    fuente_ref,documento_ref,acto_ref,huella_fuente_sha256)
   VALUES('55555555-5555-4555-8555-555555555555',3,'org:otra',2026,'plantilla-borrador','preparacion',
    '2026-01-01','2026-07-01+00','fuente:prueba','documento:plantilla','acto:regresion',repeat('b',64));
 EXCEPTION WHEN object_not_in_prerequisite_state THEN rechazada:=true;
 END;
 IF NOT rechazada THEN RAISE EXCEPTION 'plantilla publicada retrocedió a preparación'; END IF;
END $regresion$;
RESET ROLE;
...
BEGIN
 m:=jsonb_build_object('esquema','vec.personal.organizacion-historica.v1',
  ...
  'conocido_en','2026-03-01T00:00:00.000000Z','version_rpt_ref','',
 ...
 canon:='{"ambitos":{"organismo_ref":"org:otra","unidad_clave":"unidad:dos"},"atributos":'||
  '{"conocido_en":"2026-03-01T00:00:00.000000Z","cursor":"sin_seleccion","limite":"100","material_sha256":"'||
 ...
 END IF;
 -- Mismo conocimiento, corte administrativo 2025: todas las clases pasan a v2.
 m:=replace(m,'2024-12-31','2025-06-01');
 canon:='{"ambitos":{"organismo_ref":"org:otra","unidad_clave":"unidad:dos"},"atributos":'||
  '{"conocido_en":"2026-03-01T00:00:00.000000Z","cursor":"sin_seleccion","limite":"100","material_sha256":"'||
   encode(sha256(convert_to(m,'UTF8')),'hex')||'","version_plantilla_ref":"sin_seleccion","version_rpt_ref":"sin_seleccion","vigente_en":"2025-06-01"}}';
 h:=encode(sha256(convert_to(canon,'UTF8')),'hex');
 d:=jsonb_set(d,'{decision_ref}','"decision:completa2025"'::jsonb);
 d:=jsonb_set(d,'{contexto_recurso_huella_sha256}',to_jsonb(h));
 c:=jsonb_set(c,'{huella_efecto_sha256}',to_jsonb(h));
 r:=vec_personal.consultar_organizacion_historica_v1(m,convert_to(c::text,'UTF8'),
  convert_to(d::text,'UTF8'),'m'::bytea,'x'::bytea,1,1,'p'::bytea,'s'::bytea,'e'::bytea,'r'::bytea);
 IF (SELECT count(*) FROM jsonb_each(r->'pagina') e, jsonb_array_elements(e.value) v
      WHERE e.key IN ('unidades','puestos_tipo','dotaciones','plazas','puestos_individuales','vinculos')
       AND v #>> '{traza,version}'='2')<>6
    OR r #>> '{pagina,dotaciones,0,cantidad}'<>'20' THEN
  RAISE EXCEPTION 'nueva vigencia 2025 incompleta: %',r;
 END IF;
END $caso$;
COMMIT;
