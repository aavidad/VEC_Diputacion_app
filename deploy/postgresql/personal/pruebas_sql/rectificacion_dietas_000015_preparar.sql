...
-- TEST-ONLY. El stub AD3 no acredita autorización real: sustituye a las
-- fachadas AD3-61 solo en este PG18 efímero sin núcleo AD3. La instalación
-- de 000015 sobre las fachadas reales se ensaya en
