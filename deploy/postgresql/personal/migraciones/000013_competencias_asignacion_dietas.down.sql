...
BEGIN
 ...
 THEN RAISE EXCEPTION 'Personal 000013 DOWN requiere migrador superusuario' USING ERRCODE='42501'; END IF;
END $pre$;
...
BEGIN
 ...
 THEN RAISE EXCEPTION 'Personal 000013 DOWN protege recibos e historia'
