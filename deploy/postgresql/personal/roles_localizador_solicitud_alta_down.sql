...
BEGIN
 ...
 OR EXISTS(SELECT 1 FROM pg_proc WHERE pronamespace='vec_personal'::regnamespace AND proname='localizar_solicitud_alta_ejercicio_v1')
 ...
 EXECUTE format('REVOKE CONNECT ON DATABASE %I FROM vec_personal_localizador_solicitud_alta RESTRICT',current_database());
END $retirada$;
DROP ROLE vec_personal_localizador_solicitud_alta;
COMMIT;
