...
BEGIN
    LOCK TABLE vec_administracion.configuracion_correo,
               ...
               vec_administracion.auditoria_configuracion_correo IN ACCESS EXCLUSIVE MODE;
    IF EXISTS (SELECT 1 FROM vec_administracion.configuracion_correo)
       ...
       OR EXISTS (SELECT 1 FROM vec_administracion.auditoria_configuracion_correo) THEN
