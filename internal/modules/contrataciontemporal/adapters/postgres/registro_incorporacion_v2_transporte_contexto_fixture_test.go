...
// Soporte de prueba basado en los constructores nominales de CT/registro_solicitud_v3_test.go.
// Solo identidades ficticias; las claves criptográficas se generan en memoria.
import (
	"context"
	"strconv"
	"strings"
...
func registroV2_concesionAutorizacionV3Prueba(
	...
	conceder bool,
	capturar *dominiovec.InstantaneaAutorizacion,
) (
