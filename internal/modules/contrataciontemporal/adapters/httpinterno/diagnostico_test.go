...
func TestRegistroDiagnosticoClasificaCentinelaSinExponerCausa(t *testing.T) {
	...
	for _, caso := range []struct {
		...
		{"servicio analisis", "analisis_no_disponible", application.ErrServicioOperacionAnalisisInvalido},
		{"dependencia analisis", "analisis_no_disponible", application.ErrDependenciaOperacionAnalisisNoDisponible},
		{"persistencia analisis", "analisis_no_disponible", ports.ErrPersistenciaOperacionAnalisisNoDisponible},
		{"propuesta cobertura", "cobertura_no_disponible", application.ErrPresentacionPropuestaCoberturaNoDisponible},
		{"confirmacion cobertura", "cobertura_no_disponible", application.ErrConfirmacionDecisionCoberturaNoDisponible},
		{"cobertura pendiente", "cobertura_operacion_pendiente", application.ErrConfirmacionDecisionCoberturaPendiente},
