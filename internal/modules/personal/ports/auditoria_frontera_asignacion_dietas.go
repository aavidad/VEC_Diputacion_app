...
func ReferenciaRelacionValidaFrontera(v string) bool { return patronRelacionFronteraPersonal.MatchString(v) }
func ReferenciaEmpleadoValidaFrontera(v string) bool { return patronEmpleadoFronteraPersonal.MatchString(v) }
