...
func TestFirmaExigeCustodiaInteractivaValidacionesYPoliticasExactas(t *testing.T) {
	...
	casos := []struct {
		...
		{"sin_perfil_firma", func(f *FirmaDecisionTecnica) { f.PerfilFirmaAlcanzadoClave = "" }},
		{"perfil_firma_incoherente", func(f *FirmaDecisionTecnica) { f.PerfilFirmaAlcanzadoClave = "pades_baseline_t" }},
		...
		{"sin_vinculo_sello", func(f *FirmaDecisionTecnica) { f.VinculoRevisionSelladaRef = "" }},
		{"sin_validacion_documento_sellado", func(f *FirmaDecisionTecnica) { f.ValidacionDocumentoSelladoRef = "" }},
		{"sin_politica_longevidad", func(f *FirmaDecisionTecnica) { f.PoliticaLongevidadVersion = 0 }},
		{"sin_vinculo_longevidad", func(f *FirmaDecisionTecnica) { f.HuellaVinculoRevisionLongevaSHA256 = "" }},
	}
...
func firmaPrueba(contenido ContenidoDecisionTecnica, huella string, instante time.Time) FirmaDecisionTecnica {
	return FirmaDecisionTecnica{
		...
		VinculoRevisionSelladaRef:              "vinculo_revision_sellada:" + huellaPrueba("2"),
		HuellaVinculoRevisionSelladaSHA256:     huellaPrueba("2"),
		...
		VinculoRevisionLongevaRef:              "vinculo_revision_longeva:" + huellaPrueba("8"),
		HuellaVinculoRevisionLongevaSHA256:     huellaPrueba("8"),
