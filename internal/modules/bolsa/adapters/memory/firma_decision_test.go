...
func firmaMemoriaPrueba(
	...
	return dominiobolsa.FirmaDecisionTecnica{
		...
		VinculoRevisionSelladaRef:          "vinculo_revision_sellada:" + huellaMemoria("2"),
		HuellaVinculoRevisionSelladaSHA256: huellaMemoria("2"),
		...
		VinculoRevisionLongevaRef:              "vinculo_revision_longeva:" + huellaMemoria("8"),
		HuellaVinculoRevisionLongevaSHA256:     huellaMemoria("8"),
