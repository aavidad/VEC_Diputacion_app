...
func firmaMemoriaPrueba(
	...
	return dominiobolsa.FirmaDecisionTecnica{
		...
		HuellaPoliticaFirmaSHA256: huellaMemoria("1"), RequiereFirmaInteractiva: true,
		...
		NivelLongevidadClave: "pades_lta", AumentoLongevidadRef: "aumento-longevidad-decision-001",
		HuellaAumentoLongevidadSHA256: huellaMemoria("5"), PoliticaLongevidadRef: "politica-longevidad-lta",
		PoliticaLongevidadVersion: 3, HuellaPoliticaLongevidadSHA256: huellaMemoria("6"),
		ValidacionLongevidadRef:          "validacion-longevidad-decision-001",
		HuellaValidacionLongevidadSHA256: huellaMemoria("7"), AumentadaEn: firmadaEn.Add(3 * time.Minute),
		FirmadaEn: firmadaEn,
	}
}
