...
// centro confirman y con qué documento lo decide la regla c12 del catálogo.
const (
...
// confirmación a los que la regla c12 designa.
...
// fuenteReglaAcreditacionDesarrollo lee la regla c12: «valor_<modalidad>» o,
