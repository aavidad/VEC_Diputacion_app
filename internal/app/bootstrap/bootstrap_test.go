...
func TestNewHTTPServerExposesUnifiedVECShellModules(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{method: http.MethodPost, path: "/api/vec/modules/dietas/action", want: "vec module action not found", status: http.StatusNotFound},
		{method: http.MethodPost, path: "/api/vec/modules/rutas/action", want: "vec module action not found", status: http.StatusNotFound},
