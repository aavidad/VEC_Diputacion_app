...
func (a *areaPersonalBolsaDesarrollo) panel() map[string]any {
	...
	return map[string]any{"meta": map[string]any{"esquema": "vec.bolsa.area-personal.v1", "presentacion": false, "origen": "Dataset sintético de Bolsa; disponibilidad efímera del proceso", "generado_en": instanteAreaPersonalBolsaDesarrollo()}, "sesion": map[string]string{"persona_ref": candidaturaAreaPersonalDesarrollo, "nombre_visible": a.candidatura.Nombre, "iniciales": "CD", "metodo": "perfil de desarrollo sin identidad de candidato"}, "resumen": map[string]any{"acciones_pendientes": 0, "convocatorias_abiertas": 0, "solicitudes_activas": 0, "mensajes_no_leidos": 0, "puntuacion_provisional": a.candidatura.Puntuacion}, "perfil": map[string]string{"referencia": "perfil:demo:0009", "nombre_visible": a.candidatura.Nombre, "identificador_visible": "Candidatura sintética 0009", "correo": "candidatura.0009@ejemplo.test", "telefono": "No disponible", "domicilio": "No disponible", "estado_verificacion": "Sin identidad acreditada (perfil de desarrollo)"}, "plazos": vacio, "convocatorias": vacio, "meritos": vacio, "solicitudes": vacio, "baremo": vacio, "llamamientos": llamamientos, "subsanaciones": vacio, "alegaciones": vacio, "mensajes": vacio, "certificados": vacio, "documentos": vacio, "actividad": vacio, "ayuda": vacio, "disponibilidad": map[string]any{"disponible": a.disponible, "estado": estado}, "capacidades": map[string]bool{"cambiar_disponibilidad": true}}
}
