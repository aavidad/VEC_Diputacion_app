...
// VEC_CT_CANCELACION_ENABLED y los catálogos de reglas de CT (regla c20) y de
...
// fuenteReglasCancelacionDesarrollo lee la regla c20 (fases y motivos
