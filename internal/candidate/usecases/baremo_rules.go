...
func BaremoRuleSetFor(convocatoriaID, version string) (domain.BaremoRuleSet, error) {
	return domain.NewBaremoRuleSet(domain.BaremoRuleSetConfig{
		...
		MeritRules: []domain.BaremoMeritRule{
			...
			{MeritType: domain.MeritTypeExperienciaOtraCategoria, Section: domain.BaremoSectionExperiencia, Unit: domain.BaremoUnitMeses, PointsPerUnit: 0.1},
			{MeritType: domain.MeritTypeFormacionTitulo, Section: domain.BaremoSectionFormacion, Unit: domain.BaremoUnitPuntosDeclarado, PointsPerUnit: 1},
			{MeritType: domain.MeritTypeFormacionCurso, Section: domain.BaremoSectionFormacion, Unit: domain.BaremoUnitHoras, PointsPerUnit: 0.05},
			{MeritType: domain.MeritTypeOtros, Section: domain.BaremoSectionOtros, Unit: domain.BaremoUnitPuntosDeclarado, PointsPerUnit: 1},
		},
