...
// directorioFuentesAplicacionExternoPrueba resuelve runtime.Caller tambien
// cuando -trimpath conserva una ruta de modulo en vez de una ruta absoluta.
func directorioFuentesAplicacionExternoPrueba(t *testing.T) string {
	t.Helper()
