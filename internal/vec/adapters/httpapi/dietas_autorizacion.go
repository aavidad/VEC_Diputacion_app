...
func (h *Handler) atenderRutaDietas(w http.ResponseWriter, r *http.Request) bool {
	...
	case "/dietas/road-route":
		// La ruta heredada conserva su denegación anterior mientras no exista
		// una autoridad nominal compuesta para Dietas.
		if dependenciaRutaExactaNula(h.autoridadRutasDietas) {
			return false
		}
