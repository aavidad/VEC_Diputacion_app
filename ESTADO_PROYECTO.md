...
## Apéndice conservado de Módulos — 20 de septiembre de 2026
- Personal ofrece en presentación consultas públicas RPT y estructura organizativa de referencia.
- La fuente RPT versionada contiene 842 puestos tipo, 1.714 dotaciones agregadas y 145 categorías.
- La estructura proyecta 66 unidades sin ocupantes ni datos personales y no acredita cadena de mando.
- Dietas consulta el OSRM y las teselas internas para itinerarios orientativos, no liquidables.
- El itinerario admite origen, destino y paradas ordenables, con geometría y leyenda por tramo.
- Cronos y el resto de módulos visibles distinguen expresamente lo conectado de lo pendiente.
- Las acciones sin caso de uso permanecen deshabilitadas; no hay firma, envío, pago ni efecto real.
- Las lecturas de presentación no acreditan identidad corporativa, autorización productiva ni vigencia administrativa.
- El WIP durable de Dietas y Personal permanece fuera de este árbol y no debe recuperarse en esta integración.
