...
37. **Avisos personales de oportunidades.** Al entrar en su área personal, empleados y aspirantes externos podrán ver convocatorias abiertas compatibles con sus datos y abrir la ficha completa de la oferta. ¿Qué requisitos puede contrastar VEC automáticamente, qué fuentes acreditan cada dato —en especial titulaciones— y qué texto o advertencia debe mostrar cuando un requisito no pueda comprobarse? Para los casos en que la persona todavía estudia pero obtendrá el título antes de comenzar la OPE, necesitamos identificar qué bases lo permiten, en qué hito exacto debe poseerse el título, qué dato o documento acredita la previsión y cuándo se comprueba definitivamente. La admisión seguirá dependiendo de las bases y de la revisión administrativa.
