...
| Personal/RUM → área personal de Bolsa | Atributos declarados o acreditados necesarios para evaluar requisitos estructurados de convocatorias abiertas, con fuente, estado y vigencia; previsiones solo para OPE que las admitan | El evaluador separa acceso de puntuación y usa el hito fijado por las bases; una bolsa inmediata no acepta titulación futura, mientras una OPE puede devolver cumplimiento previsto y revalidarlo si sus bases lo autorizan |
