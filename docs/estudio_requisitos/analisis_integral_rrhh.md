...
| Personal/RUM → área personal de Bolsa | Atributos declarados, previstos o acreditados necesarios para evaluar requisitos estructurados de convocatorias abiertas, con fuente, estado, vigencia y fecha esperada | El evaluador separa acceso de puntuación, usa el hito de cumplimiento fijado por las bases y devuelve cumple/cumplimiento previsto/no cumple/pendiente; revalida la previsión en su fecha, no sustituye la admisión ni copia titulaciones o méritos a Bolsa |
