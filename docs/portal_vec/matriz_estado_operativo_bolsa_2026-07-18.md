...
| --- | --- | --- | --- | --- | --- | --- |
| Consulta pública | ✅ Servicio, minimización, filtros, API, catálogo y adaptador PostgreSQL | ✅ PostgreSQL 18.4/TLS, composición y prueba técnica | ✅ En `/bolsa/`, expresamente DEMO; el recorrido productivo no está desplegado | ❌ | ❌ | Aceptación RRHH, operación y despliegue autorizados. |
...
| Auditoría, recibos y registro de accesos | ✅ CAS, huellas, outbox, recibos y B2/T13 durable para consulta administrativa permitida | 🟡 B2/T13 supera PostgreSQL 18.4/TLS aislado; falta envolver accesos permitidos y denegados de cada vertical | 🧪 Cronología visual | ❌ | ❌ | T12, wrappers transaccionales de todas las verticales, HSM/KMS y composición API/web. |
...
| Importación de Convoca y migraciones | ✅ T17/B1: XLS BIFF8 endurecido, acta minimizada, staging cifrado, CAS, conciliación, conservación e historia | ✅ PostgreSQL 18/TLS aislado, incluido reinicio y reversión | ❌ | ❌ | ❌ | Wrapper VEC/T13, protector KMS/HSM, custodia externa, reconciliación corporativa y composición API/web. |
