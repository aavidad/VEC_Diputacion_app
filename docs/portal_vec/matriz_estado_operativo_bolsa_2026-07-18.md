...
| Catálogos, configuración y plazos | 🟡 Catálogos versionados y 58 categorías DEMO; reglas gobernadas por piezas | 🟡 Consulta pública DEMO; no administración completa | 🧪 Consulta; no edición autorizada | ❌ | ❌ | Catálogos validados por RRHH, editor, calendario y publicación con vigencia. |
