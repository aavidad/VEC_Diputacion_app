...
| Operación, copias, recuperación y observabilidad | 🟡 T12-A prueba copia lógica y pérdida/restauración completa de baremación V3 | 🟡 PostgreSQL 18.4 real para esa vertical; no para el módulo completo | ❌ | ❌ | ❌ | Repositorio cifrado, WAL/PITR, objetos, anclaje externo, RPO/RTO, métricas, alertas y simulacro integral. |
