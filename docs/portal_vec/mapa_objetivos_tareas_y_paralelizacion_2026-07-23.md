...
| Último commit verificado | `a677b14` — fachada VEC A2.2 cerrada con P0=P1=P2=0 |
| Trabajo local en revisión | CT `000047A4.1`: par privado de emisores nominales de cuadro y detalle. |
