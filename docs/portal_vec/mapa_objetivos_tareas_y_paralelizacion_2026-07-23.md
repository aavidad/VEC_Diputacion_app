...
| Último corte publicado completamente verde | `9622134` en `integracion/ct-o4-04e-20260726`; CI `30708360586` |
| Últimos commits técnicos verificados | `169a055` — A1 integrado con doble GO final, P0=P1=P2=0 y PostgreSQL 18.4 real; CI `30709399752` en curso |
| Cierre publicado de C2.1a | `808522d`; CI `30527303065` completamente verde |
| Trabajo no contabilizado | C2.1b, S0.1, S0.2, C2.2-A, C2.2-B, C2.3-D0, F0-D1/D2/D2c/D2d, V0, H0, H0a y A1 están cerrados técnicamente, pero no suman una puerta funcional. A2, A3, A4 y B1 quedan listos en paralelo. |
