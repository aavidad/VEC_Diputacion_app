...
| Último commit verificado | `05d6767` — par nominal A4.1 cerrado con P0=P1=P2=0 |
| Trabajo local en revisión | CT `000047A4.2` y `MAC-P1`: preparación nominal y puerto MAC no exportable. |
