...
| Último commit verificado | `c1bb5ec` — D2 y contrato M0 cerrados con P0=P1=P2=0 |
| Trabajo local en revisión | CT `000047A2.2`: fachada VEC de autorización, atestación, capacidad y material. |
