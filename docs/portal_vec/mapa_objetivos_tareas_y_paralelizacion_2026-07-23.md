...
| Último commit verificado | `bea0b4b` — servicios de cuadro/detalle migrados a A4.3 con P0=P1=0 |
| Trabajo local en revisión | A5.2 retira vías de prueba legadas; M1.1a corrige el NO-GO de adopción estructural de `000008`. |
