...
| O4-05 | API, pantalla comparativa y E2E. | La vía elegida muestra fuentes y justificación sin exponer PII indebida. | 🚧 Contrato HTTP `1a764cf`, registro modular `7a866b3`, cliente web `023b890` y recuperación propia `87a1c37`–`93674c7`, con revisiones independientes verdes. Cuatro rutas exactas, manifiestos, bloqueo de reenvío y contrato de lectura fuerte están cerrados; faltan C5, raíz productiva, proyecciones/catálogos, adaptador de recuperación y E2E. Corte interno: 3/5 hitos. |
