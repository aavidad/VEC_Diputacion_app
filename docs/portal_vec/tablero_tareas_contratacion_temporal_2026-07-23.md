...
| O2-05 | Función SQL de confirmación atómica. | Consumo único de autorización + reserva + expediente + actuación + auditoría + outbox en un `COMMIT`. | 🚧 | Candidato `cbe7299` con GO 2/2: PG18 repetido por productor y dos revisores, foco ×100, carrera, ocho fallos, cancelación, respuesta perdida, reinicio, ACL y canon V3 verdes. Autorizado para integración; todavía no cerrado ni contabilizado hasta superar las puertas conjuntas. |
