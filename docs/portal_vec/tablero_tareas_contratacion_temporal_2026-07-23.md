...
| O2-05 | Función SQL de confirmación atómica. | Consumo único de autorización + reserva + expediente + actuación + auditoría + outbox en un `COMMIT`. | 🚧 | Corrección candidata `cbe7299`: PG18 ×4 del productor y repetición de Dirección, foco ×100, carrera, ocho fallos, cancelación, respuesta perdida, reinicio, ACL y canon V3 verdes. GO 1/2; pendiente segundo dictamen independiente. No integrado. |
