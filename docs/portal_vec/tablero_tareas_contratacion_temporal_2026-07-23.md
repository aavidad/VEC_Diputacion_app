...
| O4-05 | API, pantalla comparativa y E2E. | La vía elegida muestra fuentes y justificación sin exponer PII indebida. | 🚧 Contrato HTTP `1a764cf`, registro modular inicial `7a866b3`, cliente web inicial `023b890` y recuperación propia `87a1c37`–`93674c7`, con revisiones independientes verdes. Adaptador PostgreSQL, consulta web, HTTP y quinta ruta modular cerrados aisladamente en `e36310a`, `7d4e1ec`, `42920ae` y `5965223`. Faltan raíz productiva, proyecciones/catálogos y E2E. Corte oficial: 3/5 hitos hasta superar esas puertas. |
