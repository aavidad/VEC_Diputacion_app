...
| O4-05 | API, pantalla comparativa y E2E. | La vía elegida muestra fuentes y justificación sin exponer PII indebida. | 🚧 Tres de cinco hitos. Los contratos HTTP/web, registro modular, cliente seguro, recuperación, ciclo de vida, proyecciones, autorización, recibos, acceso durable, cursores y composición visual están cerrados aisladamente. CT-000039 a CT-000045 cierran el registrador, contrato, cánones, recibo, vocabulario de estados, prueba durable, motor privado y dos fachadas nominales; `f6ba6a7`–`02b02ed` dejan barreras `25/9`, matriz integral PostgreSQL 18.4 y `GO` independiente. Producción conserva `NO-GO`: faltan el adaptador Go, composición raíz, TLS/mTLS viva y E2E HTTP completo. La trazabilidad detallada de commits se conserva en los relevos y revisiones enlazados. |
