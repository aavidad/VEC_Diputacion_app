...
| O4-05 | API, pantalla comparativa y E2E. | La vía elegida muestra fuentes y justificación sin exponer PII indebida. | 🚧 Tres de cinco hitos. Los contratos HTTP/web, registro modular, cliente seguro, recuperación, ciclo de vida, proyecciones, autorización, recibos, acceso durable, cursores y composición visual están cerrados aisladamente. CT-000039 a CT-000046 cierran registrador, contrato, cánones, recibo, vocabulario de estados, prueba durable, motor privado, fachadas nominales y adaptador Go; `1834143`–`6c57644` obtienen `GO` independiente. Producción conserva `NO-GO`: faltan composición raíz, TLS/mTLS viva y E2E HTTP completo. La trazabilidad detallada se conserva en los relevos y revisiones enlazados. |
