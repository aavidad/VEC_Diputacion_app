...
| O2-05 | Función SQL de confirmación atómica. | Consumo único de autorización + reserva + expediente + actuación + auditoría + outbox en un `COMMIT`. | 🚧 | Candidato `cbe7299` con GO 2/2 incorporado al árbol conjunto: PG18 repetido, foco ×100, carrera, ocho fallos, cancelación, respuesta perdida, reinicio, ACL y canon V3 verdes. Pendientes puertas posteriores a la integración antes de cerrar y contabilizar. |
| O2-06 | Adaptador Go de confirmación y reconciliación de resultado indeterminado. | Éxito, replay, concurrencia, timeout antes/después de `COMMIT`, reinicio y recibo adulterado. | 🚧 | Diseño `2c800fa`–`5ae0532` con GO condicionado. O2-05 ya fijó la firma real; antes de programar se ejecuta su puerta de acoplamiento y se sustituye el mapeo previsto de catorce entradas por el contrato real de doce. |
...
| O2-09 | Formulario definitivo conectado. | Accesibilidad de teclado/lector, errores, doble envío, recibo y misma interfaz sin adaptador DEMO. | 🚧 | O2-09A `1323b4b` recibió NO-GO: la vista admite periodos de más de cien años e importes RC superiores al máximo de O2-08B. Revisión visual y 50/50 pruebas favorables. Corrección acotada O2-09B pendiente; no conectado ni E2E. |
