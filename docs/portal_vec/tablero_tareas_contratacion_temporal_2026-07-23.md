...
| O2-04 | Sustituir la autorización local provisional por la capacidad durable común de VEC. | Revisión arquitectónica; no existe constructor fabricable ni segunda autoridad; pruebas de replay y vigencia. | 🚧 | Rework tras NO-GO: convergencia con O2-03 y huella exacta pendientes |
| O2-05 | Función SQL de confirmación atómica. | Consumo único de autorización + reserva + expediente + actuación + auditoría + outbox en un `COMMIT`. | 🚧 | Diseño `1f16164`; corte VEC-AD-3 `825e251`–`ff6011f` pendiente de revisión y consumo SQL |
