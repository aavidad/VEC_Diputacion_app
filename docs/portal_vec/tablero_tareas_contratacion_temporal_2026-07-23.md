...
| O2-05 | Función SQL de confirmación atómica. | Consumo único de autorización + reserva + expediente + actuación + auditoría + outbox en un `COMMIT`. | 🚧 | Corrección candidata `cbe7299`: PG18 ×4, foco ×100, carrera, matriz de ocho fallos, cancelación, respuesta perdida, reinicio, ACL y canon V3 verdes para el productor. Pendiente doble revisión independiente; no integrado. |
