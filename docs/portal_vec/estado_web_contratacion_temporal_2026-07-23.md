...
| 4 | Gestión de bolsa y comprobaciones | Parcial | 25 % | Dirección: integrar candidato de `corregir_preparador_cobertura` | Caso `b50fa…` v2 RC validada: detalle `200`; la propuesta devuelve `503` en el preparador; concurrencia ensayada sin resolver el 503; candidato preservado fuera del producto. |
