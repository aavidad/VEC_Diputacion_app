...
| Autorización VEC durable + confirmación | 🚧 | O2-04 está cerrado con GO independiente; O2-05 tiene candidato de consumo atómico y runner PostgreSQL/Go verde, pendiente de dos revisiones independientes. |
