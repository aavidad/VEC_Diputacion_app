...
Sin SQL nuevo, firma, envío, entrega ni plazo legal; evidencia central en la guía.
...
| 7. Nombramiento, parcialmente disponible | Registrar y recuperar la propuesta desde aceptación sintética; expediente `6→7`; descargar cinco borradores desde el detalle, incluida notificación. | Recibo recuperado tras reinicio principal. No hay nombramiento eficaz, posesión real, firma, envío ni entrega; queda comunicación al centro. |
...
### Descargar informe, resolución, diligencia, toma de posesión o notificación como borrador
