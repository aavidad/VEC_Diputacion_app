...
| [`internal/modules/personal/adapters/catalogosvec`](modulos_personal_cronos_dietas.md#paquete-internalmodulespersonaladapterscatalogosvec) | Modulos Personal, Cronos, Dietas y Administracion | Package catalogosvec adapta el catalogo configurable del nucleo a la consulta minimizada de categorias profesionales de Personal. |
