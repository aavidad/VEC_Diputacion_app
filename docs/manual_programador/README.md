...
### Cuatro borradores desde la misma consulta RRHH
...
el tipo solo selecciona una de las cuatro representaciones cerradas:
...
`descargar-resolucion`, `descargar-diligencia` y `descargar-toma-posesion`.
