...
// Toda la cadena se renovó después de OSM: cada importador pide una URL
// posterior a la publicada, única y versionada. El montaje interno de Dietas
// retiró la vista de presentación (itinerario, D1 y D4).
...
test("OSM renueva cada consumidor immutable desde la entrada C hasta mapa e idiomas", async () => {
  const aristas = [
    ...
    ["portal-modulos-coordinador.js", `./${dietas}mapa-ruta.js`, "20260923-dietas-r1", 1],
    ["portal-modulos-coordinador.js", `./${dietas}vista-recorridos.js`, "20260924-dietas-recuperacion-v3", 1],
    ...
    [`${dietas}vista-borradores-propios.js`, "./vista-mapa-comision.js", null, 1],
    ...["mapa-ruta.js", "vista-recorridos.js", "vista-borradores-propios.js", "vista-mapa-comision.js"]
  ...
  for (const [padre, recurso, anterior, cantidad] of aristas) {
    ...
    const esperada = recurso === "./i18n-revision.js" ? posterior(versionOSM)
...
test("OSM incorpora el estilo de ayudas F1 y renueva el catálogo de estado vacío", async () => {
  ...
  exigirVersiones(borradores, "./i18n-borradores.js", posterior(version));
});
...
test("el mapa combinado descarga consumidores nuevos también después del corrector de ayudas F1", async () => {
  for (const [padre, recurso, previa, cantidad] of [
    ...
    ["portal-modulos-coordinador.js", `./${dietas}vista-recorridos.js`, "20260924-dietas-ayuda-icono-v1", 1],
  ]) {
    const codigo = await readFile(new URL(padre, raiz), "utf8");
...
test("la cadena final no pide módulos previos a la corrección Leaflet ni al estado vacío", async () => {
  const padres = ["index.html", "portal.js", "portal-modulos-coordinador.js", "ayudante-tramites.js",
    ...["i18n.js", "mapa-ruta.js", "vista-borradores-propios.js", "vista-mapa-comision.js",
      "vista-recorridos.js"].map((nombre) => dietas + nombre)];
