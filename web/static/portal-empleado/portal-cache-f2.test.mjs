...
test("el grafo JS propio llega desde HTML a los consumidores F2 con versiones nuevas", async () => {
  ...
  for (const recurso of ["modulos/cronos/vista.js",
    ...
    exigirVersiones(coordinador, `./${recurso}`, recurso === "modulos/cronos/vista.js" ? posterior(versionCronosVista)
      : recurso === "modulos/dietas/cliente-borradores-http.js" ? posterior(version) : ["modulos/personal/vista-ficha-integral.js", "modulos/nominas/vista.js"].includes(recurso) ? versionVistasC : version,
