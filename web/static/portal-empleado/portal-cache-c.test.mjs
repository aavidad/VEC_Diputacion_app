...
const entrada = "20260924-web-c-ayuda-v7";
const cronos = "20260924-cronos-integrado-v1";
const dietas = "20260924-dietas-ayuda-icono-v1";
const sinGuia = "20260924-dietas-ayuda-sin-guia-v2";
const preparacion = "20260924-dietas-preparacion-sin-guia-v3";
...
test("capa C no reutiliza los consumidores previos de B con caché immutable", async () => {
  ...
  const aristas = [
    ...
    [coordinador, "./modulos/dietas/vista-recorridos.js", "20260924-f2-consulta-v2", preparacion, 2],
...
test("la ayuda de Dietas no reutiliza C v3 ni las vistas y CSS anteriores", async () => {
  ...
  const aristas = [
    ...
    [coordinador, "./modulos/dietas/vista-recorridos.js", recuperacion, preparacion, 2],
...
test("el corrector Dietas descarga de nuevo la cadena que tenía C inicial", async () => {
  ...
  const aristas = [
    ...
    [coordinador, "./modulos/dietas/vista-recorridos.js", "20260924-dietas-d1d2d4", preparacion, 2],
    [recorridos, "./vista-borradores-propios.js", "20260924-dietas-d1d2d4", preparacion, 1],
  ];
