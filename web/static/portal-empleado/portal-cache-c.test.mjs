...
const entrada = "20260924-web-c-ayuda-v4";
...
test("la ayuda de Dietas no reutiliza C v3 ni las vistas y CSS anteriores", async () => {
  ...
  const aristas = [
    ...
    [coordinador, "./modulos/dietas/vista-recorridos.js", recuperacion, dietas, 2],
...
test("el corrector Dietas descarga de nuevo la cadena que tenía C inicial", async () => {
  ...
  const aristas = [
    ...
    [coordinador, "./modulos/dietas/vista-recorridos.js", "20260924-dietas-d1d2d4", dietas, 2],
