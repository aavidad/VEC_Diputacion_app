...
import { crearPresentadorPanelInterno } from "./portal-panel-interno.js?v=20260926-huecos-bolsa-reglas-v1";
...
import { AYUDA_PORTAL_BOLSA, detectarContextoContratacionTemporal, obtenerAyudaContratacionTemporal, renderizarAyudaContratacionTemporal, TRAMITES_AYUDANTE_PORTAL } from "./ayuda-contenido.js?v=20260926-huecos-analisis-v1";
import { crearAyudanteTramites } from "./ayudante-tramites.js?v=20260926-huecos-analisis-v1";
...
import { CLAVES_SIN_ENTRADA_PORTAL, CODIGO_CARGA_SUSTITUIDA, crearCoordinadorModulosPortal, moduloDeVistaPortal, rutaDeVistaPortal, vistaConEntradaPortal, VISTA_DOCUMENTOS_EXPEDIENTE, VISTAS_MODULOS_PERSONALES } from "./portal-modulos-coordinador.js?v=20260926-huecos-coberturas-v1";
...
import { crearControladorBolsas } from "./portal-bolsas-api.js?v=20260926-huecos-bolsa-reglas-v1";
import { crearSuperficieBorradorLlamamiento } from "./portal-borrador-llamamiento-ui.js?v=20260921-bback01-v1";
import { consultarAvisosBolsa, manejarAccionAvisos } from "./portal-bolsas-avisos.js?v=20260926-huecos-bolsa-reglas-v1";
