...
import { CODIGO_CARGA_SUSTITUIDA, crearCoordinadorModulosPortal, moduloDeVistaPortal, rutaDeVistaPortal, VISTAS_MODULOS_PERSONALES } from "./portal-modulos-coordinador.js?v=20260925-d5d6-v1";
...
import { accesoBolsaEfectivo, aplicarDisponibilidadMenuBolsa, instalarMenuBolsa, resumenAccesosModulos, sincronizarMenuBolsa, vistaBolsaNavegable, VISTAS_INTERNAS_BOLSA } from "./portal-menu-bolsa.js?v=20260925-d5d6-v1";
import { traducirPortal } from "./portal-i18n.js?v=20260925-d5d6-v1";
import { crearControladorBolsas } from "./portal-bolsas-api.js?v=20260925-d5d6-v1";
