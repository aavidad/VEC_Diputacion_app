import { crearControladorPortal } from "./portal-eventos.js?v=20260925-d6p2-v1";
...
import { AYUDA_PORTAL_BOLSA, detectarContextoContratacionTemporal, obtenerAyudaContratacionTemporal, renderizarAyudaContratacionTemporal } from "./ayuda-contenido.js?v=20260925-d6p2-v1";
import { crearAyudanteTramites } from "./ayudante-tramites.js?v=20260925-d6p2-v1";
import { crearSuperficieBorradoresPortal } from "./portal-borradores-ui.js?v=20260925-d6p2-v1";
...
import { crearCoordinadorModulosPortal, moduloDeVistaPortal, rutaDeVistaPortal, VISTAS_MODULOS_PERSONALES } from "./portal-modulos-coordinador.js?v=20260925-d6p2-v1";
import { crearTraductorPersonal } from "./modulos/personal/i18n.js?v=20260925-b2-sin-refs-v1";
import { crearVistaInicioPortal } from "./portal-inicio.js?v=20260925-d6p2-v1";
