import { crearControladorPortal } from "./portal-eventos.js?v=20260924-f2-cronos-permisos-v2";
...
import { AYUDA_PORTAL_BOLSA, detectarContextoContratacionTemporal, obtenerAyudaContratacionTemporal, renderizarAyudaContratacionTemporal } from "./ayuda-contenido.js?v=20260924-osm-base-v3";
import { crearAyudanteTramites } from "./ayudante-tramites.js?v=20260924-osm-base-v3";
import { crearSuperficieBorradoresPortal, instalarDeeplinkAvisosBorradores } from "./portal-borradores-ui.js?v=20260924-f2-cronos-permisos-v2";
...
import { crearCoordinadorModulosPortal, moduloDeVistaPortal, rutaDeVistaPortal, VISTAS_MODULOS_PERSONALES, VISTAS_PRESENTACION_VISUALES } from "./portal-modulos-coordinador.js?v=20260924-osm-base-v3";
