import { crearControladorPortal } from "./portal-eventos.js?v=20260926-reparos-informe-v1";
import { crearPresentadorPanelInterno } from "./portal-panel-interno.js?v=20260926-reparos-informe-v1";
...
import { AYUDA_PORTAL_BOLSA, detectarContextoContratacionTemporal, obtenerAyudaContratacionTemporal, renderizarAyudaContratacionTemporal, TRAMITES_AYUDANTE_PORTAL } from "./ayuda-contenido.js?v=20260926-reparos-informe-v1";
import { crearAyudanteTramites } from "./ayudante-tramites.js?v=20260926-reparos-informe-v1";
import { crearSuperficieBorradoresPortal } from "./portal-borradores-ui.js?v=20260926-reparos-informe-v1";
import { crearUtilidadesVista } from "./portal-vistas-utilidades.js?v=20260926-reparos-informe-v1";
import { crearVistasOperaciones } from "./portal-vistas-operaciones.js?v=20260924-f2-shell-v1";
import { CLAVES_SIN_ENTRADA_PORTAL, CODIGO_CARGA_SUSTITUIDA, crearCoordinadorModulosPortal, moduloDeVistaPortal, rutaDeVistaPortal, vistaConEntradaPortal, VISTA_DOCUMENTOS_EXPEDIENTE, VISTAS_MODULOS_PERSONALES } from "./portal-modulos-coordinador.js?v=20260926-reparos-informe-v1";
import { crearTraductorDocumentos } from "./modulos/documentos/i18n.js?v=20260925-documentos-web-v3";
import { consultarSesionPortal, presentarSesionPortal } from "./portal-catalogo-modulos.js?v=20260926-reparos-informe-v1";
import { crearTraductorPersonal } from "./modulos/personal/i18n.js?v=20260925-personal-e10-v1";
import { crearVistaInicioPortal } from "./portal-inicio.js?v=20260926-reparos-informe-v1";
import { accesoBolsaEfectivo, aplicarDisponibilidadMenuBolsa, instalarMenuBolsa, resumenAccesosModulos, sincronizarMenuBolsa, vistaBolsaNavegable, VISTAS_INTERNAS_BOLSA } from "./portal-menu-bolsa.js?v=20260926-reparos-informe-v1";
...
import { crearControladorBolsas } from "./portal-bolsas-api.js?v=20260926-reparos-informe-v1";
import { crearSuperficieBorradorLlamamiento } from "./portal-borrador-llamamiento-ui.js?v=20260921-bback01-v1";
import { consultarAvisosBolsa, manejarAccionAvisos } from "./portal-bolsas-avisos.js?v=20260926-referencias-legibles-v1";
