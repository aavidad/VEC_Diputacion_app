...
const versionEntradaNueva = "20260924-osm-base-v2";
const versionVistaNueva = "20260924-osm-base-v2";
...
test("la consulta Dietas atraviesa caché caliente desde HTML hasta ambos cargadores", async () => {
  ...
  assert.match(vista, /vista-borradores-propios\.js\?v=20260924-osm-base-v2/u);
