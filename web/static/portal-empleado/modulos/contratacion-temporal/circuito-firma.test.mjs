...
test("la ayuda explica el circuito de ejemplo y la falta de eficacia sin portafirmas", async () => {
  ...
  assert.match(ayuda, /ayuda_contenido_404: "El «Circuito de firma»/u);
  assert.match(ayuda, /ayuda_contenido_405: ".*no tiene eficacia administrativa.*portafirmas corporativo/u);
});
