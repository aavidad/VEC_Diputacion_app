...
import { CLAVES_I18N_FICHA_GINPIX, montarFichaGINPIX } from "./ficha-ginpix.js";
...
test("i18n: la ficha usa las claves del catálogo común", () => {
  for (const clave of CLAVES_I18N_FICHA_GINPIX) assert.equal(typeof MENSAJES_CONTRATACION_TEMPORAL_ES[clave], "string");
});
