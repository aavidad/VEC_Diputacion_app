const MENSAJES_ADMINISTRACION_ES = Object.freeze({
  ...
  ia_endpoint: "Endpoint local", ia_endpoint_ejemplo: "http://localhost:11434", ia_modelo: "Modelo local", ia_indice: "Índice documental", ia_modelo_ejemplo: "Modelo pendiente de seleccionar", ia_indice_ejemplo: "Índice pendiente de aprobar",
  ...
  tab_apariencia: "Apariencia", apariencia_titulo: "Tema del portal", apariencia_descripcion: "Compare los temas aprobados en esta pantalla.", apariencia_elegir: "Elegir tema para la vista previa",
  ...
  apariencia_error_aplicar: "No se pudo aplicar la vista previa.", apariencia_error_restablecer: "No se pudo restablecer el tema anterior.", apariencia_reintentar: "Reintentar",
