...
function panelSolicitante(documento, t, areaBorradores, areaItinerario, puedeCrear) {
  ...
  const cerrar = nodo(documento, "button", t("cerrar_nueva_comision"));
  cerrar.type = "button";
  ...
  cabeceraRevision.append(nodo(documento, "h3", t("revision_titulo")), nodo(documento, "p", t("revision_instruccion")));
