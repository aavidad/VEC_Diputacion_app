...
test("el coordinador respeta DEC-051 y carga el presentador con versión de caché", () => {
  ...
  assert.match(html, /portal\.js\?v=20260924-web-c-ayuda-v7/);
  assert.match(javascript, /portal-modulos-coordinador\.js\?v=20260924-web-c-ayuda-v7/);
  assert.doesNotMatch(html, /portal\.js\?v=20260924-web-c-ayuda-v6/);
  assert.doesNotMatch(javascript, /portal-modulos-coordinador\.js\?v=20260924-web-c-ayuda-v6/);
