...
test("el coordinador respeta DEC-051 y carga el presentador con versión de caché", () => {
  ...
  assert.match(html, /portal\.js\?v=20260920-dietas-acordeon-v7/);
  assert.match(html, /dietas\/dietas\.css\?v=20260920-dietas-acordeon-v7/);
  assert.match(javascript, /portal-modulos-coordinador\.js\?v=20260920-dietas-acordeon-v7/);
