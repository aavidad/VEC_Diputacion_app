...
const versionEntrada = "20260924-web-c-ayuda-v7";
...
test("una caché caliente descarga el grafo renovado hasta Personal i18n", async () => {
  const cache = new Map([
    ...
    ["/portal-empleado/portal.js?v=20260924-web-c-ayuda-v4", "/* portal anterior de ayuda Dietas */"],
    ...
    ["/portal-empleado/portal.js?v=20260924-web-c-ayuda-v6", "/* portal anterior de ayuda Dietas */"],
    ["/portal-empleado/portal-modulos-coordinador.js?v=20260924-web-c-ayuda-v6", "/* coordinador anterior de ayuda Dietas */"],
