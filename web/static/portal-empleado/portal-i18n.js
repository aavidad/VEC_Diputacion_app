...
export const MENSAJES_PORTAL_ES = Object.freeze({
  admin_correo_titulo: "Configuración SMTP",
  admin_correo_titulo_formulario: "Configuración SMTP de Diputación",
  admin_correo_cargando: "Comprobando acceso administrativo…",
  admin_correo_denegado: "No tiene acceso a esta configuración.",
  admin_correo_cuenta_pendiente: "La cuenta puede quedar pendiente hasta que Sistemas la cree.",
  admin_correo_host: "Host o IP",
  admin_correo_puerto: "Puerto",
  admin_correo_servidor: "Nombre servidor (SNI)",
  admin_correo_ca: "Referencia CA",
  admin_correo_remitente: "Remitente fijo",
  admin_correo_usuario: "Usuario",
  admin_correo_secreto: "Contraseña o token",
  admin_correo_tls: "Modo TLS",
  admin_correo_tls_implicito: "TLS implícito",
  admin_correo_starttls: "STARTTLS obligatorio",
  admin_correo_autenticacion: "Autenticación",
  admin_correo_ninguna: "Ninguna",
  admin_correo_plain: "Usuario y contraseña",
  admin_correo_oauth: "Token OAuth",
  admin_correo_tiempo: "Tiempo máximo (ms)",
  admin_correo_guardar: "Guardar",
  admin_correo_secreto_presente: "Secreto configurado (no visible).",
  admin_correo_secreto_ausente: "Sin secreto configurado.",
  admin_correo_conflicto: "La configuración cambió; recargue antes de guardar.",
  admin_correo_error_guardado: "No se pudo guardar la configuración.",
