...
} from "./portal-catalogo-modulos.js?v=20260925-notificaciones-v1";
import { traducirPortal } from "./portal-i18n.js?v=20260925-notificaciones-v1";
import { calcularMetricasCuadro, tramitesParaInicio } from "./portal-inicio.js?v=20260925-notificaciones-v1";
import {
  componerCronosInterno,
  componerDietasInternas,
  componerPersonalVisible,
  componerRegistroPersonal,
} from "./portal-composicion-empleado.js?v=20260925-notificaciones-v1";
...
const CARGADORES_INTERNOS_PREDETERMINADOS = Object.freeze({
  ...
  cronos: async () => {
    const [saldo, remoto, movimientos, movimientosPropios, permisosPropios,
      ...
      import("./modulos/cronos/vista-permisos-propios.js?v=20260925-notificaciones-v2"),
      ...
      import("./modulos/cronos/vista-bandeja-permisos.js?v=20260925-notificaciones-v1"),
      import("./modulos/cronos/vista-avisos-propios.js?v=20260925-resolucion-v1"),
      import("./modulos/cronos/cliente-resolucion-http.js"),
      import("./modulos/cronos/i18n-resolucion.js"),
      import("./modulos/cronos/vista-notificaciones-propias.js?v=20260925-notificaciones-v2"),
      import("./modulos/cronos/vista-bandeja-notificaciones.js?v=20260925-notificaciones-v2"),
  ...
  dietas: async () => {
    const [contrato, recorridos, clienteBorradores, clienteAsignacion, calculador, mapa, clienteCircuito] = await Promise.all([
      ...
      import("./modulos/dietas/vista-recorridos.js?v=20260925-notificaciones-v1"),
      ...
      import("./modulos/dietas/mapa-ruta.js?v=20260925-notificaciones-v1"),
