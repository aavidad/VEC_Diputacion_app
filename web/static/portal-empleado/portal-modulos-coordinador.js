...
const CARGADORES_INTERNOS_PREDETERMINADOS = Object.freeze({
  ...
  cronos: async () => {
    const [saldo, remoto, movimientos, movimientosPropios, permisosPropios,
      ...
      import("./modulos/cronos/vista-notificaciones-propias.js?v=20260925-notificaciones-v1"),
      import("./modulos/cronos/vista-bandeja-notificaciones.js?v=20260925-notificaciones-v1"),
