...
const CARGADORES_INTERNOS_PREDETERMINADOS = Object.freeze({
  ...
  dietas: async () => {
    const [contrato, recorridos, clienteBorradores, clienteAsignacion, calculador, mapa, clienteCircuito] = await Promise.all([
      ...
      import("./modulos/dietas/vista-recorridos.js?v=20260925-d5-v1"),
      import("./modulos/dietas/cliente-borradores-http.js?v=20260925-d5-v1"),
      import("./modulos/dietas/cliente-asignacion-http.js?v=20260925-tanda-v1"),
      import("./modulos/dietas/calculador-rutas-http.js?v=20260925-d5-v1"),
      import("./modulos/dietas/mapa-ruta.js?v=20260925-d5-v1"),
