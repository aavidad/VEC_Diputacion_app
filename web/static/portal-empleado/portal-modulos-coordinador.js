...
} from "./portal-catalogo-modulos.js?v=20260926-reparos-firma-v1";
import { traducirPortal } from "./portal-i18n.js?v=20260926-reparos-firma-v1";
import { calcularMetricasCuadro, tramitesParaInicio } from "./portal-inicio.js?v=20260926-reparos-firma-v1";
import {
...
import { VISTAS_INTERNAS_BOLSA } from "./portal-menu-bolsa.js?v=20260926-reparos-firma-v1";
import {
...
const CARGADORES_INTERNOS_PREDETERMINADOS = Object.freeze({
  ...
  dietas: async () => {
    const [contrato, recorridos, clienteBorradores, clienteAsignacion, calculador, mapa, clienteCircuito] = await Promise.all([
      ...
      import("./modulos/dietas/vista-recorridos.js?v=20260926-reparos-firma-v1"),
      ...
      import("./modulos/dietas/mapa-ruta.js?v=20260926-reparos-firma-v1"),
