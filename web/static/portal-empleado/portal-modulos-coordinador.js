...
import { VISTAS_INTERNAS_BOLSA } from "./portal-menu-bolsa.js?v=20260926-recorrido-main-v1";
import {
  CLAVES_CARGA_MODULAR,
  LIMITE_CARGA_MODULAR_MS,
  cargarModuloConLimite,
  consultarConLimite,
} from "./portal-modulos-carga.js?v=20260926-recorrido-main-v1";
...
const CARGADORES_INTERNOS_PREDETERMINADOS = Object.freeze({
  ...
  contratacion_temporal: async () => {
    const [contrato, cliente, presentador, vista, adaptador] = await Promise.all([
      ...
      import("./modulos/contratacion-temporal/vista-expedientes.js?v=20260926-recorrido-main-v1"),
