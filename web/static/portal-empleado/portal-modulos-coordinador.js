...
const CARGADORES_PRESENTACION_PREDETERMINADOS = Object.freeze({
  ...
  dietas: async () => {
    const [contrato, vista, mapa, calculador, recorridos] = await Promise.all([
      ...
      import("./modulos/dietas/vista-itinerario.js?v=20260924-dietas-ayuda-sin-guia-v2"),
      import("./modulos/dietas/mapa-ruta.js?v=20260923-dietas-r1"),
      import("./modulos/dietas/calculador-rutas-presentacion-osrm.js"),
      import("./modulos/dietas/vista-recorridos.js?v=20260924-dietas-preparacion-sin-guia-v3"),
    ]);
