...
} from "./portal-catalogo-modulos.js?v=20260926-huecos-rrhh-v1";
import { traducirPortal } from "./portal-i18n.js?v=20260926-huecos-rrhh-v1";
import { calcularMetricasCuadro, tramitesParaInicio } from "./portal-inicio.js?v=20260926-huecos-rrhh-v1";
import {
...
import { VISTAS_INTERNAS_BOLSA } from "./portal-menu-bolsa.js?v=20260926-huecos-rrhh-v1";
import {
...
const CARGADORES_INTERNOS_PREDETERMINADOS = Object.freeze({
  ...
  contratacion_temporal: async () => {
    const [contrato, cliente, presentador, vista, adaptador] = await Promise.all([
      ...
      import("./modulos/contratacion-temporal/vista-expedientes.js?v=20260926-propuesta-sucesor-v1"),
  ...
  dietas: async () => {
    const [contrato, recorridos, clienteBorradores, clienteAsignacion, calculador, mapa, clienteCircuito] = await Promise.all([
      ...
      import("./modulos/dietas/vista-recorridos.js?v=20260926-huecos-rrhh-v1"),
      ...
      import("./modulos/dietas/mapa-ruta.js?v=20260926-huecos-rrhh-v1"),
