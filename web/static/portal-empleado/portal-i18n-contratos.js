...
export const MENSAJES_CONTRATOS_ES = Object.freeze({
  ...
  navegacion_titulo: "Contratos, ceses y reincorporación",
  seccion_contratos: "Contratos y relaciones",
  seccion_ceses: "Ceses",
  seccion_reincorporacion: "Reincorporación en Bolsa",
  accion_pendiente: "Actuación pendiente",
  descripcion_ceses: "El cese requiere un hecho confirmado por Personal. La consulta de relaciones no sustituye su recibo.",
  descripcion_reincorporacion: "Bolsa determina la disponibilidad después de recibir el cese acreditado y aplicar su política vigente.",
