...
export const TRAMITES_AYUDANTE_PORTAL = Object.freeze([
  ...
  Object.freeze({
    ...
    pasos: Object.freeze([
      ...
      Object.freeze({ selector: "[data-dietas-area-itinerario]", bloqueado: false, titulo: "Revisar el resultado", instruccion: "Puede previsualizar otra alternativa OSRM. La elección y su motivo solo cambian esta vista; no se guardan ni generan importe. Escriba entre 8 y 500 caracteres para previsualizar una ruta distinta de la recomendada.", objetivo: "Identificar la información que deberá verificarse en el expediente.", preparacion: "Motivo documentado de cualquier ajuste.", resultado: "Se muestra una estimación técnica separada del trámite.", actor: "Persona solicitante y, después, gestión.", limite: "La validación de kilómetros y la liquidación dependen de reglas y revisión posteriores." }),
    ]),
  }),
  Object.freeze({
