...
const respaldo = Object.freeze({
  ...
  "areaPersonal.ayuda.descripcion": "Guías, preguntas frecuentes y opciones de lectura.", "areaPersonal.ayuda.guia.titulo": "Guía de uso", "areaPersonal.ayuda.guia.subtitulo": "Texto completo de la ayuda", "areaPersonal.ayuda.guia.encabezado": "Leer esta ayuda", "areaPersonal.ayuda.guia.texto": "Esta guía explica el área personal de Bolsa. En Inicio aparecen plazos y acciones pendientes. En Nueva solicitud elige una convocatoria con plazo abierto y la prepara en cuatro pasos (requisitos, datos, méritos y revisión); cada paso guarda un borrador que puede retomar desde cualquier dispositivo. Al presentarla recibe un justificante interno con número y fecha, que no es un asiento de registro ni una firma. En Mis solicitudes consulta su estado. La puntuación de autobaremo es orientativa y la revisará Recursos Humanos. La firma, el registro en sede, el pago de tasas y la notificación electrónica aún no están disponibles.", "areaPersonal.ayuda.guia.limiteServicio": "Cada operación real depende de la confirmación del servicio autorizado.",
