import { exigirParametrosConocidos, iniciarAreaPersonal } from "./aplicacion.js?v=20260926-convoca-f1-v2";
...
async function resolverCliente() {
  ...
  const [{ crearClienteHTTPAreaPersonal }, { crearClienteSolicitudesPersona }] = await Promise.all([
    ...
    import("./cliente-http-solicitudes.js?v=20260926-convoca-f1-v2"),
  ]);
