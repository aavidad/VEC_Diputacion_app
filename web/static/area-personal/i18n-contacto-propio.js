export const textosContactoPropio = Object.freeze({
  ...
  intencionNoDisponible: "No se puede preparar un reintento seguro del correo. No se ha enviado la operación.",
  reintentarOriginal: "El último guardado no está confirmado. Para no cambiar la intención pendiente, reintente el correo original.",
  botonReintentarOriginal: "Reintentar correo original",
