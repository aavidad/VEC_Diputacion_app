...
**Aspecto concreto** (menú, cabecera, tarjetas, tablas, KPI, estados y ritmo): lo fija la skill `aspecto-vec` con las maquetas de RRHH como referencia. Aplicar las dos juntas.
