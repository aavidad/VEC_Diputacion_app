...
MANIFIESTO_VISTAS: tuple[Vista, ...] = (
    ...
    *_vistas_rrhh(),
    ...
    Vista(
        ...
        ruta="/portal-empleado/?presentacion=rrhh&perfil=funcionario#dietas",
...
MANIFIESTO_FLUJOS: tuple[Flujo, ...] = (
    ...
    Flujo(
        ...
        pasos=(PasoInteraccion("esperar", '#sesion-visible[data-actor-ref="DEMO-PERFIL-TECNICO-RRHH-01"]'),
               PasoInteraccion("esperar-habilitado", '[data-modulo-portal="bolsa"][data-vista="resumen"]'),
               PasoInteraccion("esperar-deshabilitado", '[data-modulo-portal="cronos"]'),
               PasoInteraccion("esperar-deshabilitado", '[data-modulo-portal="dietas"]'),
    ...
    Flujo(
        clave="funcionario-autoservicio-restringido", nombre="Funcionario con autoservicio restringido",
        superficie="gestion-rrhh",
        ruta="/portal-empleado/?presentacion=rrhh&perfil=funcionario#portal",
        selector_titulo="#titulo-vista", titulo_esperado="Portal del Empleado",
        selectores_listos=(".aviso-presentacion:not([hidden])", "#espacio-trabajo > :first-child"),
        pasos=(PasoInteraccion("esperar", '#sesion-visible[data-actor-ref="DEMO-PERFIL-FUNCIONARIO-01"]'),
               PasoInteraccion("esperar-deshabilitado", '[data-modulo-portal="bolsa"]'),
               PasoInteraccion("esperar-habilitado", '[data-modulo-portal="cronos"][data-vista="cronos"]'),
