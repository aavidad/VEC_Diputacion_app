...
V19 generó BASE+M001..M195, con 195 transformaciones compilables muertas y cero
supervivientes. Un ledger V19 separado conserva BASE+cuatro mutantes SEC
...
go run ./tools/o3a_v5_ast/validar_manifest \
  ...
  ./tools/o3a_v5_ast/evidencia/ledger_v19_m001_m195.tsv \
  ./tools/o3a_v5_ast/evidencia/ledger_v19_sec.tsv
go run ./tools/o3a_v5_ast -dir "$pruebas_sql" >/tmp/o3a-v5-dag.json
```

Los ficheros anteriores a `ledger_v19_*` son evidencia genealógica revocada.
...
única autoridad mutante del corte es el par V19 nombrado en el comando anterior
